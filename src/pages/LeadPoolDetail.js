...
const LeadPoolDetail = () => {
    ...
    return (
      <div className="lead-pool-detail-container">
        <div className="loading-container">
          <p className="loading-text">Loading lead pool details...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <LoadingIcon text="Loading lead pool details..." isLoading={isLoading}>
      <div className="lead-pool-detail-container">
        ...
        <div className="leads-section">
          ...
          {leadsLoading ? (
            <LoadingIcon text="Loading leads..." isLoading={leadsLoading} />
          ) : leads.length > 0 ? (
            <>
